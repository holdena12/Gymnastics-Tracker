...
// Organized by event with skill names and difficulty values

export const skillsDatabase = {
    "Floor Exercise": [
        // A Skills (0.1)
        { name: "Straight leg forward roll", difficulty: "A", value: 0.1 },
        { name: "Backward roll to handstand", difficulty: "A", value: 0.1 },
        { name: "Cartwheel", difficulty: "A", value: 0.1 },
        { name: "Round-off", difficulty: "A", value: 0.1 },
        ...
        { name: "Front handspring", difficulty: "B", value: 0.2 },
        { name: "Backward somersault tucked", difficulty: "B", value: 0.2 },
        ...
        { name: "Back somersault straight", difficulty: "C", value: 0.3 },
        { name: "Front somersault piked", difficulty: "C", value: 0.3 },
        ...
        { name: "Back somersault with full turn", difficulty: "D", value: 0.4 },
        { name: "Front somersault with 1/2 turn", difficulty: "D", value: 0.4 },
        ...
        { name: "Double back somersault straight", difficulty: "E", value: 0.5 },
        { name: "Double front somersault piked", difficulty: "E", value: 0.5 },
        { name: "Back somersault double full", difficulty: "E", value: 0.5 },
        ...
        { name: "Triple front somersault", difficulty: "G", value: 0.7 },
        { name: "Quadruple back somersault", difficulty: "G", value: 0.7 },
        
        // H Skills (0.8)
        { name: "Biles", difficulty: "H", value: 0.8 },
        { name: "Biles II", difficulty: "H", value: 0.8 }
    ],

    "Pommel Horse": [
        // A Skills (0.1)
        { name: "Single leg cut", difficulty: "A", value: 0.1 },
        { name: "Scissors", difficulty: "A", value: 0.1 },
        ...
        { name: "Stockli", difficulty: "B", value: 0.2 },
        { name: "Moore", difficulty: "B", value: 0.2 },
        ...
        { name: "Tong Fei", difficulty: "C", value: 0.3 },
        { name: "Bezugo", difficulty: "C", value: 0.3 },
        ...
        { name: "Magyar", difficulty: "D", value: 0.4 },
        { name: "Russian 1080", difficulty: "D", value: 0.4 },
    ...
    "Still Rings": [
        // A Skills (0.1)
        { name: "Support scale (2 sec)", difficulty: "A", value: 0.1 },
        { name: "L-support (2 sec)", difficulty: "A", value: 0.1 },
        { name: "Back uprise", difficulty: "A", value: 0.1 },
        ...
        { name: "Kip", difficulty: "B", value: 0.2 },
        { name: "Back lever (2 sec)", difficulty: "B", value: 0.2 },
        { name: "Front lever (2 sec)", difficulty: "B", value: 0.2 },
        ...
        { name: "Cross (2 sec)", difficulty: "C", value: 0.3 },
        { name: "Back somersault", difficulty: "C", value: 0.3 },
        ...
        { name: "Guczoghy", difficulty: "D", value: 0.4 },
    ...
    "Parallel Bars": [
        ...
        { name: "V-support (2 sec)", difficulty: "B", value: 0.2 },
        { name: "Handstand (2 sec)", difficulty: "B", value: 0.2 },
        { name: "Back uprise", difficulty: "B", value: 0.2 },
        ...
        { name: "Diamidov", difficulty: "C", value: 0.3 },
        { name: "Back somersault", difficulty: "C", value: 0.3 },
        { name: "Front somersault", difficulty: "C", value: 0.3 },
        ...
        { name: "Double back somersault", difficulty: "D", value: 0.4 },
        { name: "Healy", difficulty: "D", value: 0.4 },
        { name: "Makuts", difficulty: "D", value: 0.4 },
    ...
    "High Bar": [
        // A Skills (0.1)
        { name: "Cast", difficulty: "A", value: 0.1 },
        { name: "Back hip circle", difficulty: "A", value: 0.1 },
        ...
        // B Skills (0.2)
        { name: "Cast to handstand", difficulty: "B", value: 0.2 },
        { name: "Giant swing", difficulty: "B", value: 0.2 },
        { name: "Tap swing", difficulty: "B", value: 0.2 },
        ...
        { name: "Gienger", difficulty: "C", value: 0.3 },
        { name: "Deltchev", difficulty: "C", value: 0.3 },
        ...
        { name: "Def", difficulty: "D", value: 0.4 },
        { name: "Galante", difficulty: "D", value: 0.4 },
